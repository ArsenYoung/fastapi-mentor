...
@router.get(
    "/{student_id}",
    summary="Get a student and their courses",
...
@router.get(
    "",
    summary="Get students and their courses",
    response_model=StudentsPaginatedList,
    status_code=status.HTTP_200_OK,
)
...
@router.delete(
    "/{student_id}",
    summary="Delete a student and their courses",
