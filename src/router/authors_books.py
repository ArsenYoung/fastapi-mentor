...
@router.post(
    ...
    summary="Create an author and their books",
...
async def get_author_with_books(
    author_id: int, service: AuthorsBooksService = Depends(get_authors_books_service)
) -> Author:
...
@router.get(
    "",
    response_model=AuthorsPaginatedList,
...
@router.delete(
    "/{author_id}",
    summary="Delete an author and their books",
